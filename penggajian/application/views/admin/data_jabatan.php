...
<div class="container-fluid" style="margin-bottom: 100px">
    ...
    <a class="btn btn-sm btn-success mb-4" href="<?php echo base_url('admin/data_jabatan/tambah_data') ?>"><i class="fas fa-plus"></i>Tambah Data</a>
    ...
    <table class="table table-bordered table-striped mt-2">
        ...
        <?php $no=1; foreach($jabatan as $j) : ?>
            <tr>
                ...
                <td>
                    <center>
                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/data_jabatan/update_data/'.$j->id_jabatan) ?>"><i class="fas fa-edit"></i></a>
