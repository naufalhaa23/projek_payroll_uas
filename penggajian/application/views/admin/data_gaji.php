...
<div class="container-fluid" style="margin-bottom: 100px">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-inline">
                ...
                <?php if(count($gaji) > 0) {?>
                    <a href="<?php echo base_url('admin/data_penggajian/cetak_gaji?bulan='.$bulan),'&tahun='.$tahun ?>" class="btn btn-success mb-2 ml-2"><i class="fas fa-print"></i> Cetak Daftar Gaji</a>
                <?php  }else{?>
    ...
    <?php }else{ ?>
        <span class="badge badge-danger"><i class="fas fa-info-circle">Data absensi kosong, silahkan input data kehadiran pada bulan dan tahun yang Anda pilih.</i></span>
    <?php } ?>
</div>
